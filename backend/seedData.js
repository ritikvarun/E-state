...
const initialInquiries = [
  {
    ...
    message: "I would like to request a private showing for the penthouse on Tuesday afternoon. Please confirm if wire proof of funds is required prior to tour.",
    tourDate: "2026-08-15",
    tourTime: "14:00",
    agentEmail: "victoria@estatepro.com",
    status: "new",
  ...
  },
  {
    ...
    message: "Interested in receiving the full disclosure package and architectural floor plans for the Bel Air property.",
    tourDate: "2026-08-18",
    tourTime: "11:00",
    agentEmail: "julian@estatepro.com",
    status: "read",
